...
### Profile Handler
* The above steps were implemented to test the profile route handler. As indicated by the image below, this route handler was functioning as expected at the time of submission by redirecting the user to the reviews page and subsequently passed this test. 
