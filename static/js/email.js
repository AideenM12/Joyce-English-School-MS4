...
/* The contactUs variable is used to create to the
 submit event listener to trigger the thankYou function*/
...
/* thankYouMsg variable allows and thankYou function allow
 and thank you response to display if the form
...
function thankYou() {
    ...
    document.getElementById("thank-you-msg").innerHTML =
